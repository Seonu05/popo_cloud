...
public class Player { //운동 선수를 추상화한 클래스

	//----- 속성 -----
	// * 캡슐화 원칙 : 클래스의 멤버 변수(필드)에 private을 붙여
	//				외부로부터 직접 접근을 차단하는 것
	
	
	//public String name;//이음 (캡슐화 미적용)
	...
	//2) 속성(멤버변수, 필드)를 외붕서 간접 접근할 수 있는 기능
	//		--> getter /setter 메소드
	
	//name에 대한 get/setter 작성
	
	//getter : 객체의 값을 외부로 반환하는 기능을 구현한 메소드
	//외부에서 접근할 수 있도록 public으로 선언해야함.
	public String getName() {
		// -->String (반환형) : 메소드 수행 후 반환되는 값의 자료형 
		
		//return : 메소드 종료 시 호출한 곳으로 
		//			돌려보내는 값을 작성.
		return name;
		//외부에서 getName() 호출 시 객체에 저장 되어있는  name 반환
	}
	...
	//getter
	//public 반환형 get 변수명(){ //변수명 시작은 대문자
	//	return 변수명(필드명);
	//}
