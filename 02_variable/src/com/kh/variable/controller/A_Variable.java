...
public class A_Variable {
	...
	public void usingVariable() {
		...
		System.out.println(pi * r * r * h); //원기둥
	...
	public void declareVariable() {
		...
		//0.9999999999999 (double) 정확도가 2배
		
		//double은 float보다 정확도(소수점 표현 길이)가 2배 크다(길다)
		
		double dNum; //8byte ---> 실수형 중에 기본형
		
		//3.문자형
		// 문자형 변수는 문자 딱 하나만을 저장 할 수 있다.
		char ch; //(자바는)2byte
		...
		// 선언한  변수에 값 대입
		isTrue = true;  //위에 41줄에 논리형으로[boolean isTrue;] 선언함
		isTrue = false;
		// boolean 자료형 변수에 대입 될 수 있는 값(리터럴)은
		// true 또는 false 뿐이다.
		...
		str = "A";
		//String의 자료형 리터럴 표기법은 ""(쌍따옴표)
		//한 글자만 작성해도 쌍따옴표로 표기해야 한다.
		...
		System.out.println("인트 변수에 저장 된 값 : " + 인트);
	...
	public void initVariable() {
		...
		System.out.println("isTrue에 초기화 된 값 : " + isTrue);
		
		System.out.println("bNum에 초기화된 값 : " + bNum);
		System.out.println("sNum에 초기화 된 값 : " + sNum);
		System.out.println("iNum에 초기화 된 값 : " + iNum);
		System.out.println("lNum에 초기화 된 값 : " + lNum);
		
		System.out.println("fNum에 초기화 된 값 : " + fNum);
		System.out.println("dNum에 초기화 된 값 : " + dNum);
		
		System.out.println("ch에 초기화 된 값 : " + ch);
		
		System.out.println("str에 초기화 된 값 : " + str);
