...
public class B_Switch {
	...
	//switch문은 딱 떨어지는 값이 조건식으로 작성돼야한다.
	...
	public void example2() {
		...
		//두수를 연산한 결과를 출력.
		//단, 잘못된 연산자 입력시 "연산자를 잘못 입력하셨습니다." 출력
	...
	public void example3() {
		...
		//사과일 경우 3천원, 바나나일 경우 2천원, 복숭아 일경우 8천원을 출력
		...
		int price = 0; //과일의 가격을 저장할 변수 price 선언 및 0으로 초기화
	...
	public void example4() {
		...
		case 2: System.out.println("28일 또는 29일"); break;
